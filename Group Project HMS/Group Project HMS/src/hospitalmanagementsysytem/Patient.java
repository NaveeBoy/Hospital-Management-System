...
public class Patient extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblPNumber.setFont(new java.awt.Font("Segoe UI", 1, 16)); // NOI18N
        lblPNumber.setForeground(new java.awt.Color(255, 255, 0));
        lblPNumber.setText("jLabel5");
        ...
        jPanel2Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(lblPNumber, javax.swing.GroupLayout.PREFERRED_SIZE, 64, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Patient No", "Patient Name", "Age", "Gender", "Phone", "Address", "Medical History"
            }
        ));
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        try {
            pst =con.prepareStatement("INSERT INTO patient (PatientNo,Name,Age,Gender,Phone,Address,MedicalHis) VALUES (?,?,?,?,?,?,?)");
            pst.setString(1, pno);
    ...
    private void jTable1MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jTable1MouseClicked
        ...
        txtPAge.setText(d1.getValueAt(SelectIndex, 2).toString());
        ...
        txtMedicalHistory.setText(d1.getValueAt(SelectIndex, 6).toString());
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            pst =con.prepareStatement("UPDATE patient set Name=?,Age=?,Gender=?,Phone=?,Address=?,MedicalHis=? WHERE PatientNo=?");
